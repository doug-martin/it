...
EventEmitter.extend({
    instance: {
        ...
        constructor: function constructor(description, options) {
            ...
            _.bindAll(this, ["_addAction", "_addTest", "timeout", "getAction", "beforeAll", "beforeEach", "afterAll", "afterEach", "context", "get", "set"]);
        },
        ...
        _addTest: function (description, cb) {
            ...
            _(["suite", "test", "should", "describe", "timeout", "getAction", "beforeAll", "beforeEach",
                "afterAll", "afterEach", "context", "get", "set"]).forEach(function (key) {
